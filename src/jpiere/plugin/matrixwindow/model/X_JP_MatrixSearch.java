...
@org.adempiere.base.Model(table="JP_MatrixSearch")
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_MatrixSearch (Properties ctx, int JP_MatrixSearch_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_MatrixSearch_ID, trxName, virtualColumns);
      /** if (JP_MatrixSearch_ID == 0)
        {
			setAD_Field_ID (0);
			setAD_Tab_ID (0);
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_MatrixSearch (Properties ctx, String JP_MatrixSearch_UU, String trxName)
    {
      super (ctx, JP_MatrixSearch_UU, trxName);
      /** if (JP_MatrixSearch_UU == null)
        {
			setAD_Field_ID (0);
			setAD_Tab_ID (0);
// @0|AD_Tab_ID@
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_MatrixSearch (Properties ctx, String JP_MatrixSearch_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_MatrixSearch_UU, trxName, virtualColumns);
      /** if (JP_MatrixSearch_UU == null)
        {
			setAD_Field_ID (0);
			setAD_Tab_ID (0);
...
// 1
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_MatrixSearch[")
